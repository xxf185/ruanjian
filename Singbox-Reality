...
menu() {
	...
	echo -e "  ${YELLOW}3. 卸载SingBox${PLAIN}"
	echo -e "  ${YELLOW}4. 启动SingBox${PLAIN}"
	echo -e "  ${YELLOW}5. 重启SingBox${PLAIN}"
	echo -e "  ${YELLOW}6. 停止SingBox${PLAIN}"
	echo -e "  ${YELLOW}7. 查看SingBox配置${PLAIN}"
	echo -e "  ${YELLOW}8. 查看SingBox日志${PLAIN}"
