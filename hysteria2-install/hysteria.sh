...
insthysteria(){
    ...
    wget -N https://raw.githubusercontent.com/xxf185/hysteria2-install/main/install_server.sh
...
menu() {
    clear
    echo ""
    echo -e "--------------${YELLOW}Hysteria 2 一键安装脚本${PLAIN}--------------"
    echo ""
    echo -e " 1.安装Hysteria2"
    echo -e " 2.卸载Hysteria2"
    echo -e " 3.关闭.开启.重启Hysteria 2"
    echo -e " 4.修改Hysteria2配置"
    echo -e " 5.显示Hysteria2配置"
    echo ""
    echo -e " 0. 退出脚本"
    echo ""
